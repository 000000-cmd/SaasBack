...
public class UserController {
    ...
    @PatchMapping("/me/welcome-seen")
    public ResponseEntity<ApiResponse<Void>> welcomeSeen(@AuthenticationPrincipal IUserPrincipal principal) {
        userUseCase.markFirstLoginSeen(principal.getUserId());
        return ResponseEntity.ok(ApiResponse.success(null, "Bienvenida marcada como vista"));
    }
