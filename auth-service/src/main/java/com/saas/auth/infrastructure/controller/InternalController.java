...
public class InternalController {
    ...
    /** Payload de UN usuario, para el reindex puntual desde la gestion de Elastic. */
    @GetMapping("/users/one/{id}")
    public UserEventPayload oneForReindex(@PathVariable UUID id) {
        return UserEventPayload.from(userUseCase.loadWithRoles(id));
    }
